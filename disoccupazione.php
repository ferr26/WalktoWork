...
function query($regione) {
    ...
    $sql = "SELECT SUM(percentualedisoccupazione) from datasetdisoccupazione where regione = '$regione'";
    $result = $connessione->query($sql);
    if ($result->num_rows >0) {
        // output data of each row
        while($row = $result->fetch_assoc()) {  
        $somma = $row["SUM(percentualedisoccupazione)"];            
        $media = $somma/19;
       }
    } else {
        echo "0 results";
...
<body>
			...
			<div class="row">
				...
				<main id="main" class="col-md-9">
					<div class="blog">
						...
						<p>Media di disoccupazione dal 1995 al 2013 Regioni Italiane</p> 
    ...
    data: {
        ...
        datasets: [{
            ...
            <?php echo $valoreMediaSardegna?>, 0, 65],
            backgroundColor: [
                'rgba(255, 99, 132, 0.2)',
                'rgba(54, 162, 235, 0.2)',
                'rgba(255, 206, 86, 0.2)',
