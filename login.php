   ...
   //COMPAGNIA
    ...
    //non fare niente perchè la lista è vuota
     ...
     $linkFinale='https://it.indeed.com/jobs?q&l='.$citta.'&start='.$x.'&advn='.$url6.'&vjk='.$codice2 ;
        ...
        $hrefs7 = $xpath->evaluate("(//span[@class='company'])[$i]/a/@href");
        //QUI INSERIRE CONTROLLO , se $hrefs è vuota allora non è un azienda con recensione quindi non mettere la stellina nella tabella
        $href7 = $hrefs7->item(0);
        $url_recensione="https://it.indeed.com".$href7;
		...
		echo  "      
          ...
          <td> <a href=\" $url_recensione \"> <i class=\"fa fa-star-o	\" style=\" font-size:23px; color:#1ac6ff\"></i>  </a> </td>
          </tr>
